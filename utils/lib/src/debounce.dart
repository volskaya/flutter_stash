...
final _timeouts = HashMap<Function, _DebounceTimer>();
...
class Debounce {
  ...
  static void duration(
    ...
    _timeouts[target] = _DebounceTimer(timeout, target, positionalArguments, namedArguments);
  }
