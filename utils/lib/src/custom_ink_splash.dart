...
const Duration _kUnconfirmedSplashDuration = Duration(milliseconds: 250 * durationMultiplier);
...
class CustomSplash extends InteractiveInkFeature {
  ...
  void _endAnimations() {
    if (_alphaController.value < 0.5) {
      _alphaController.animateTo(1, duration: const Duration(milliseconds: 50 * durationMultiplier));
    }
