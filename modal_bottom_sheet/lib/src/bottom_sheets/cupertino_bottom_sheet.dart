...
class _CupertinoBottomSheetContainer extends StatelessWidget {
  ...
  const _CupertinoBottomSheetContainer({Key key, this.child, this.backgroundColor, @required this.topRadius})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final shadow = BoxShadow(blurRadius: 10, color: Colors.black12, spreadRadius: 5);
...
class CupertinoModalBottomSheetRoute<T> extends ModalBottomSheetRoute<T> {
  ...
  Widget buildTransitions(
    ...
    final distanceWithScale = (paddingTop + _behind_widget_visible_height) * 0.9;
