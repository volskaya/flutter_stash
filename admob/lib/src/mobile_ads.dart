...
class MobileAds {
  ...
  static String get interstitialAdVideoTestUnitId =>
      Platform.isAndroid ? 'ca-app-pub-3940256099942544/8691691433' : 'ca-app-pub-3940256099942544/5135589807';
  ...
  /// ```
  ///
  /// TODO: Allow passing test device IDs.
  static Future<void> initialize({
    ...
    _debugCheckIsTestId(MobileAds.nativeAdUnitId, [nativeAdTestUnitId, nativeAdVideoTestUnitId]);
    ...
    MobileAds.interstitialAdUnitId ??= interstitialAdUnitId ?? interstitialAdTestUnitId;
    _debugCheckIsTestId(MobileAds.interstitialAdUnitId, [interstitialAdTestUnitId, interstitialAdVideoTestUnitId]);
  ...
  static Future<void> setChildDirected(bool directed) async {
    await _pluginChannel.invokeMethod('setChildDirected', {'directed': directed});
  }
  ...
  static const _pluginChannel = const MethodChannel('admob');
