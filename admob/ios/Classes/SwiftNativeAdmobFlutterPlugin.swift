...
public class SwiftAdmobPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "admob", binaryMessenger: registrar.messenger())
    let instance = SwiftAdmobPlugin()
